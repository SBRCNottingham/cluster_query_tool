...
\begin{itemize}
 ...
 \item \textbf{\textit{Arabidopsis thaliana} protein-protein interaction network (Arabidopsis PPI)} \cite{ArabidopsisConsortium2011}
  ...
  \item \textbf{\textit{Escherichia coli} protein-protein interaction network (E.coli PPI) \cite{}}
...
\begin{figure*}
    ...
    \end{subfigure}
    \caption{ROC scores for the high quality labels for real networks described in Section \ref{sec:real_networks}. 
