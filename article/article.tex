...
\acmYear{2018}
\copyrightyear{2018 Copyright held by the owner/author(s).}
\acmPrice{}
...
\begin{figure}[t]
    \includegraphics[width=0.48\textwidth]{images/search_space_3.png}
...
For the tests performed in this work we use a restart probability $\alpha = 0.5$.
...
As with the non-overlapping results, the scores are comparable with the rwr method with performance slightly better in the case of 1000 node models.
...
\begin{figure*}[t]
\includegraphics[width=0.8\textwidth]{images/ppi_example_combined.eps}
